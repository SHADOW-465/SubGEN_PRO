export async function extractAudio(file: File): Promise<string> {
  // Create an OfflineAudioContext to decode the audio data
  ...
  // We want to downsample to 16kHz mono to save bandwidth/token usage for the LLM
...
function bufferToWav(abuffer: AudioBuffer) {
  ...
  setUint16(16); // 16-bit (hardcoded in this specific implementation)
